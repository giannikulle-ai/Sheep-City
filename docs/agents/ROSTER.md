...
| Ticket | Lane | Branch | PR | Gate | Status at 14:05 UTC |
|---|---|---|---|---|---|
...
Sim merge order: #60 first (save v6), then #43 and #61 after merging trunk. #40 the engine starts as soon as #59 and #60 land; #63 after #60. Check-ins hourly during the sprint, back to four-hourly when it is merged. Pins open: #69, #73 (#74 pinned 13:52 UTC).
