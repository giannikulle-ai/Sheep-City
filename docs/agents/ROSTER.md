...
| Ticket | Lane | Branch | PR | Gate | Status at 14:10 UTC |
|---|---|---|---|---|---|
...
Sim merge order: #60 first (save v6), then #43 and #61 after merging trunk. #40 the engine starts as soon as #59 and #60 land; #63 after #60. Check-ins hourly during the sprint, back to four-hourly when it is merged. Pins open: #69 (#74 pinned 13:52 UTC, #73 pinned 14:00 UTC). #71 and #72 merge trunk (now carrying #73) before their own merge.
