...
if __name__ == "__main__":
    ...
    S = 5; f = ImageFont.truetype("/usr/share/fonts/truetype/dejavu/DejaVuSans-Bold.ttf", 13)
    rows = [("sheep." + k, v) for k, v in SHEEP_ANIMS.items()] + [("lamb." + k, v) for k, v in LAMB_ANIMS.items()] + [("digital_luna." + k, v) for k, v in DL_ANIMS.items()]
    cw, ch = 44, 44
    ...
    sheet.save("/home/claude/v2/check_hand_anims.png"); print("ok", sheet.size)
