...
# v2 vector comparison tool (not part of the v3 build). Paths are relative to this script;
# render_v3 imports to_palette/PAL/hex2rgb from here, so nothing may touch the disk at import time.
HERE = os.path.dirname(os.path.abspath(__file__))
SVG = os.path.join(HERE, "build", "svg")
OUT = os.path.join(HERE, "build", "v2out")
